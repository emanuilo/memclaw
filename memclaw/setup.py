...
KEYS = [
    ...
    ("WHATSAPP_PHONE_NUMBER_ID", "WhatsApp Business phone number ID", False),
    ("WHATSAPP_ACCESS_TOKEN", "WhatsApp Cloud API access token", False),
    ("WHATSAPP_VERIFY_TOKEN", "WhatsApp webhook verification token", False),
    ("WHATSAPP_ALLOWED_NUMBERS", "Allowed WhatsApp numbers (comma-separated, e.g. +1234567890)", False),
]
